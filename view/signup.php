    ...
    <div class="container active">
        ...
        <form method="POST" id="signup-form">
            <div class="input-field">
                <input type="text" value="<?php echo $nameSignup??''?>" placeholder="Enter your name" name="nameSignup" id="signup-username" oninput="checkName()">
            ...
            <div class="input-field">
                <input type="text" value="<?php echo $emailSignup??''?>" placeholder="Enter your email" name="emailSignup" id="signup-email" oninput="checkEmailSignup()">
            ...
            <div class="input-field">
                <input type="password" value="<?php echo $passwordSignup??''?>" class="password" placeholder="Create a password" id="signup-password" name="passwordSignup" oninput="checkPasswordSignup()">
            ...
            <div class="input-field">
                <input type="password" value="<?php echo $Repeatpassword??''?>" class="password" placeholder="Confirm a password" id="signup-Repasword" name="Repeatpassword" oninput="checkMatchPassword()">
